// Auto-generated. Per-entity form-enhancements config for "Wartungsplan".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["maschine", "wartungsart", "wartungsintervall", { row: ["letzte_wartung", "naechste_wartung"] }, "status", { row: ["verantwortlich_vorname", "verantwortlich_nachname"] }, { row: ["durchgefuehrt_vorname", "durchgefuehrt_nachname"] }, "bemerkungen"],
  defaults: {
    'letzte_wartung': { kind: 'today' },
    'naechste_wartung': { kind: 'todayOffset', days: 30 },
    'status': { kind: 'lookup', key: 'ausstehend', label: 'Ausstehend' },
  },
  computed: {
    '_wartungsplan_intervall_tage': { kind: 'dateDiff', from: 'letzte_wartung', to: 'naechste_wartung', unit: 'days' },
  },
};
