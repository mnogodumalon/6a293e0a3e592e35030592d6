// Auto-generated. Per-entity form-enhancements config for "Maschinen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["maschinenname", "maschinentyp", "seriennummer", "hersteller", "baujahr", "standort_gebaeude", "standort_bereich", "beschreibung"],
  defaults: {
    'baujahr': { kind: 'literal', value: new Date().getFullYear() },
  },
  computed: {},
};
